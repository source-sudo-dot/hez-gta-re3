...
#define MAX_VISIBLE_OPTION_ON_SCREEN (m_nCurrScreen == MENUPAGE_KEYBOARD_CONTROLS ? CONTSETUP_MAX_VISIBLE_ROWS : hasNativeList(m_nCurrScreen) ? MAX_VISIBLE_LIST_ROW : MAX_VISIBLE_OPTION)
