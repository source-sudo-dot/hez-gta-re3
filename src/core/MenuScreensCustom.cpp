...
CMenuScreenCustom aScreens[MENUPAGES] = {
	...
	{ "FET_LG", MENUPAGE_NEW_GAME, MENUPAGE_NEW_GAME, nil, nil,
		...
		MENUACTION_CHECKSAVE,	"FEZ_ASL", { nil, SAVESLOT_10,		MENUPAGE_LOAD_SLOT_CONFIRM },
	},
   ...
   { "FEG_MAP", MENUPAGE_NONE, MENUPAGE_NONE, nil, nil,
	...
	{ "FET_GFX", MENUPAGE_OPTIONS, MENUPAGE_OPTIONS,
		new CCustomScreenLayout({MENUSPRITE_MAINMENU, 50, 0, 0, 20, FONT_HEADING, FESCREEN_LEFT_ALIGN, true, MEDIUMTEXT_X_SCALE, MEDIUMTEXT_Y_SCALE}), GraphicsGoBack,
	...
	{ "FEC_JOD", MENUPAGE_CONTROLLER_PC, MENUPAGE_CONTROLLER_PC,
		new CCustomScreenLayout({MENUSPRITE_MAINMENU, 40, 0, 60, 20, FONT_BANK, FESCREEN_LEFT_ALIGN, false, MEDIUMTEXT_X_SCALE, MEDIUMTEXT_Y_SCALE}), DetectJoystickGoBack,
