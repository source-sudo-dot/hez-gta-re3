...
// lands.  The shape says whether it was a head shot, the colour whether it killed.
class CCrosshair
{
public:
	// ModernCrosshair under [Display] in reVC.ini
	static bool bModern;
	// HitMarkers under [Display] in reVC.ini
